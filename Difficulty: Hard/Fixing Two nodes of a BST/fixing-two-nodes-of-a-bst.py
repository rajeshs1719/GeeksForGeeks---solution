...
class Solution:
    def correctBST(self, root):
        ...
        if self.first and self.last:
            self.first.data, self.last.data = self.last.data, self.first.data  # Non-adjacent nodes swapped
        elif self.first and self.middle:
            self.first.data, self.middle.data = self.middle.data, self.first.data  # Adjacent nodes swapped
